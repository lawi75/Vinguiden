...
public enum BitmapManager {
	...
	public void queueJob(final String url, final ImageView imageView, final int width, final int height) {
			...
			public void handleMessage(Message msg) {
				...
				if (tag != null && tag.equals(url)) {
					if (msg.obj != null) {
						...
						Log.d(BitmapManager.class.getName(), "fail " + url);
					}
				}
			}
		};
		...
		pool.submit(new Runnable() {
			...
			public void run() {
				...
				message.obj = bmp;
				Log.d(BitmapManager.class.getName(), "Item downloaded: " + url);
	...
	public void loadBitmap(final String url, final ImageView imageView, final int width, final int height) {
		...
		if (bitmap != null) {
			Log.d(BitmapManager.class.getName(), "Item loaded from cache: " + url);
